...
var StickerSheet = function StickerSheet(_ref) {
  var pages = _ref.pages,
    dailyDeliveries = _ref.dailyDeliveries;
    ...
    children: pages.map(function (page, pageIndex) {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("div", {
        ...
        children: page.map(function (label, labelIndex) {
          var _label$address, _label$customer_name, _label$customer_phone;
          return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsxs)("div", {
            className: "label",
            children: [(_label$address = label === null || label === void 0 ? void 0 : label.address) !== null && _label$address !== void 0 ? _label$address : 'no_address', /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("br", {}), (_label$customer_name = label === null || label === void 0 ? void 0 : label.customer_name) !== null && _label$customer_name !== void 0 ? _label$customer_name : 'customer_name', " - ", (_label$customer_phone = label === null || label === void 0 ? void 0 : label.customer_phone) !== null && _label$customer_phone !== void 0 ? _label$customer_phone : 'customer_phone', /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("br", {}), labelIndex]
          }, labelIndex);
        })
      }, pageIndex);
    })
...
/***/ "./resources/js/components/containers/stickerSheet.js":
/*!************************************************************!*\
  !*** ./resources/js/components/containers/stickerSheet.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _StickerSheet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../StickerSheet */ "./resources/js/components/StickerSheet.js");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,react_redux__WEBPACK_IMPORTED_MODULE_1__.connect)(function (_ref) {
  var dailyDeliveries = _ref.dailyDeliveries;
  return {
    dailyDeliveries: dailyDeliveries
  };
}, {})(_StickerSheet__WEBPACK_IMPORTED_MODULE_0__["default"]));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_containers_stickerSheet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../components/containers/stickerSheet */ "./resources/js/components/containers/stickerSheet.js");
...
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! antd */ "./node_modules/antd/es/button/index.js");
...
/* harmony import */ var _redux_Order_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../redux/Order/actions */ "./resources/js/redux/Order/actions.js");
/* harmony import */ var _redux_Common_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../redux/Common/actions */ "./resources/js/redux/Common/actions.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _config_axiosClient__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../config/axiosClient */ "./resources/js/config/axiosClient.js");
/* harmony import */ var _MapViewOfRoute__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./MapViewOfRoute */ "./resources/js/pages/Admin/Order/MapViewOfRoute.js");
...
var StickerView = function StickerView(_ref) {
  var _deliveryStickers$dat;
  ...
  var _useSelector = (0,react_redux__WEBPACK_IMPORTED_MODULE_10__.useSelector)(function (state) {
    ...
    deliveryWindows = _useSelector.deliveryWindows,
    deliveryStickers = _useSelector.deliveryStickers;
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
    _useState4 = _slicedToArray(_useState3, 2),
    deliveryZoneID = _useState4[0],
    setDeliveryZoneID = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
    _useState6 = _slicedToArray(_useState5, 2),
    deliveryWindowID = _useState6[0],
    setDeliveryWindowID = _useState6[1];
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
    _useState8 = _slicedToArray(_useState7, 2),
    directionResponse = _useState8[0],
    setDirectionResponse = _useState8[1];
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    dispatch((0,_redux_Common_actions__WEBPACK_IMPORTED_MODULE_5__.getDeliveryWindowsList)());
  }, []);
  var updateDeliveryZone = function updateDeliveryZone(value) {
    setDeliveryZoneID(value);
  };
  var updateDeliveryWindow = function updateDeliveryWindow(value) {
    setDeliveryWindowID(value);
  };
  var fetchStickers = function fetchStickers() {
    if (deliveryWindowID && deliveryZoneID) {
      dispatch((0,_redux_Order_actions__WEBPACK_IMPORTED_MODULE_4__.getStickerData)({
        delivery_zone_id: deliveryZoneID,
        delivery_window_id: deliveryWindowID
      }));
    }
  };
  var stickerData = ['Label 1', 'Label 2', 'Label 3', 'Label 4', 'Label 5', 'Label 6', 'Label 7', 'Label 8', 'Label 9', 'Label 10', 'Label 11', 'Label 12', 'Label 13', 'Label 14', 'Label 15', 'Label 16', 'Label 17', 'Label 18', 'Label 19', 'Label 20', 'Label 21', 'Label 22', 'Label 23', 'Label 24', 'Label 25', 'Label 26', 'Label 27', 'Label 28', 'Label 29', 'Label 30', 'NEXT 31', 'NEXT 32', 'NEXT 1', 'NEXT 2', 'NEXT 3', 'NEXT 4', 'NEXT 5', 'NEXT 6', 'NEXT 7', 'NEXT 8'];
  ...
  var selectValidation = function selectValidation() {
    if (!deliveryWindowID || !deliveryZoneID) {
      antd__WEBPACK_IMPORTED_MODULE_11__["default"].error('Please select Delivery Zone and Window');
      return;
    }
  };
  var handleOptimizeRoute = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            setLoading(true);
            _context.next = 5;
            return (0,_config_axiosClient__WEBPACK_IMPORTED_MODULE_7__.postRequest)('order/optimizeRoute', {
              delivery_zone_id: deliveryZoneID,
              delivery_window_id: deliveryWindowID
            });
          case 5:
    ...
    return function handleOptimizeRoute() {
  ...
  var handleDownloadCSV = function handleDownloadCSV() {
    ...
    if (_.isEmpty(deliveryStickers.data)) {
      antd__WEBPACK_IMPORTED_MODULE_11__["default"].error('No deliveries fetch to download');
      return;
    }
    var csvData = deliveryStickers.data.map(function (_ref3) {
      var customer_name = _ref3.customer_name,
        customer_email = _ref3.customer_email,
        customer_phone = _ref3.customer_phone,
    ...
    var csv = papaparse__WEBPACK_IMPORTED_MODULE_2___default().unparse(csvData);
    var blob = new Blob([csv], {
      type: 'text/csv'
    });
    var a = document.createElement('a');
    a.href = URL.createObjectURL(blob);
    a.download = "route_csv_".concat(deliveryZoneID, "_").concat(deliveryWindowID, "_").concat(dayjs__WEBPACK_IMPORTED_MODULE_3___default()(new Date()).format("DD_MM_YYYY"));
  ...
  var pages = splitStickerDataIntoPages((_deliveryStickers$dat = deliveryStickers === null || deliveryStickers === void 0 ? void 0 : deliveryStickers.data) !== null && _deliveryStickers$dat !== void 0 ? _deliveryStickers$dat : stickerData, labelsPerPage);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.Fragment, {
    children: [loading && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_12__["default"], {
      tip: "Loading..."
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_13__["default"], {
      gutter: 16,
      className: "sticker_page_header",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_14__["default"], {
        span: 18,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_15__["default"], {
          children: [!(0,lodash__WEBPACK_IMPORTED_MODULE_6__.isEmpty)(deliveryWindows) ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_16__["default"], {
          ...
          }) : null, !(0,lodash__WEBPACK_IMPORTED_MODULE_6__.isEmpty)(deliveryZoneList) ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_16__["default"], {
            placeholder: "Select Delivery Zone",
          ...
          }) : null, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_17__["default"], {
            type: 'primary',
            onClick: fetchStickers,
            children: "Fetch Stickers"
          })]
        })
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)("br", {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_13__["default"], {
      gutter: 16,
      className: "sticker_page_header",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_14__["default"], {
        span: 18,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(antd__WEBPACK_IMPORTED_MODULE_15__["default"], {
          ...
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_17__["default"], {
            type: 'primary',
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(antd__WEBPACK_IMPORTED_MODULE_14__["default"], {
        span: 14,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_MapViewOfRoute__WEBPACK_IMPORTED_MODULE_8__["default"], {
          directionResponse: directionResponse
        })
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_containers_stickerSheet__WEBPACK_IMPORTED_MODULE_1__["default"], {
      pages: pages
    })]
  });
};
